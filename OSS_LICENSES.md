...
| --- | --- | --- | --- |
| `@expo-google-fonts/dm-mono` | 0.4.2 | MIT AND OFL-1.1 | [link](https://github.com/expo/google-fonts) |
| `@expo-google-fonts/noto-sans-kr` | 0.4.3 | MIT AND OFL-1.1 | [link](https://github.com/expo/google-fonts) |
| `@expo/vector-icons` | 15.1.1 | MIT | [link](https://github.com/expo/vector-icons) |
| `@react-native-async-storage/async-storage` | 2.2.0 | MIT | [link](https://github.com/react-native-async-storage/async-storage) |
